...
class Render(context: Context) : GLSurfaceView.Renderer {
    ...
    override fun onDrawFrame(gl: GL10) {
        ...
        drawPlanet(gl, mercury, mercuryAngle, 0.4f, 1.7f, 1)
        drawPlanet(gl, venus, venusAngle, 0.6f, 1.5f, 2)
        drawPlanet(gl, earth, earthAngle, 0.8f, 1.3f, 3)
        drawMoon(gl, moon, earthAngle, moonAngle, 0.8f, 4)
        drawPlanet(gl, mars, marsAngle, 1.0f, 1.1f, 5)
        drawPlanet(gl, jupiter, jupiterAngle, 1.5f, 1.0f, 6)
        drawPlanet(gl, saturn, saturnAngle, 1.7f, 0.7f, 7)
        drawPlanet(gl, uranus, uranusAngle, 2.0f, 0.5f, 8)
        drawPlanet(gl, neptune, neptuneAngle, 2.2f, 0.3f, 9)
        drawPlanet(gl, pluto, plutoAngle, 2.5f, 0.2f, 10)
